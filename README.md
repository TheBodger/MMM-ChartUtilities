...
`type`|No|the type of the value when added tot he item|numeric (will validate using pasrsefloat) or string|string
...
"setidx":[] // will start at "1" on the current hierachy 
}
